...
#ifndef FOREVER_SYNCHRONIZATION_WAITABLE_EVENT_H_
#define FOREVER_SYNCHRONIZATION_WAITABLE_EVENT_H_

#include <condition_variable>
#include <mutex>

#include "../macros.h"
#include "../timer/time_delta.h"
...
class AutoResetWaitableEvent final {
 ...
 private:
  ...
  FOREVER_DISALLOW_COPY_AND_ASSIGN(AutoResetWaitableEvent);
};
...
class ManualResetWaitableEvent final {
 ...
 private:
  ...
  FOREVER_DISALLOW_COPY_AND_ASSIGN(ManualResetWaitableEvent);
};

}  // namespace FOREVER

#endif  // FOREVER_SYNCHRONIZATION_WAITABLE_EVENT_H_
