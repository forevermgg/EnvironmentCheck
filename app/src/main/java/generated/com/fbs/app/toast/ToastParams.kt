...
class ToastParams : Table() {
    ...
    companion object {
        ...
        fun createToastParams(builder: FlatBufferBuilder, contentOffset: Int, duration: Int, systemsDuration: Int) : Int {
            builder.startTable(3)
            addSystemsDuration(builder, systemsDuration)
            addDuration(builder, duration)
            addContent(builder, contentOffset)
            return endToastParams(builder)
        }
        fun startToastParams(builder: FlatBufferBuilder) = builder.startTable(3)
        ...
        fun addSystemsDuration(builder: FlatBufferBuilder, systemsDuration: Int) = builder.addInt(2, systemsDuration, 0)
