...
#ifndef FOREVER_SYNCHRONIZATION_SEMAPHORE_H_
#define FOREVER_SYNCHRONIZATION_SEMAPHORE_H_
...
class Semaphore {
 ...
 private:
  ...
  FOREVER_DISALLOW_COPY_AND_ASSIGN(Semaphore);
};

}  // namespace FOREVER

#endif  // FOREVER_SYNCHRONIZATION_SEMAPHORE_H_
