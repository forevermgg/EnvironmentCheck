...
inline const Duration (&EnumValuesDuration())[2] {
  static const Duration values[] = {
    Duration_LENGTH_SHORT,
...
inline const char *EnumNameDuration(Duration e) {
  if (flatbuffers::IsOutRange(e, Duration_LENGTH_SHORT, Duration_LENGTH_LONG)) return "";
...
struct ToastParams FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  com::fbs::app::toast::Duration systemsDuration() const {
    return static_cast<com::fbs::app::toast::Duration>(GetField<int32_t>(VT_SYSTEMSDURATION, 0));
  }
...
struct ToastParamsBuilder {
  ...
  void add_systemsDuration(com::fbs::app::toast::Duration systemsDuration) {
    fbb_.AddElement<int32_t>(ToastParams::VT_SYSTEMSDURATION, static_cast<int32_t>(systemsDuration), 0);
  }
...
inline flatbuffers::Offset<ToastParams> CreateToastParams(
    ...
    int32_t duration = 0,
    com::fbs::app::toast::Duration systemsDuration = com::fbs::app::toast::Duration_LENGTH_SHORT) {
...
inline flatbuffers::Offset<ToastParams> CreateToastParamsDirect(
  ...
  return com::fbs::app::toast::CreateToastParams(
      _fbb,
      content__,
      duration,
      systemsDuration);
...
inline const com::fbs::app::toast::ToastParams *GetToastParams(const void *buf) {
  return flatbuffers::GetRoot<com::fbs::app::toast::ToastParams>(buf);
}

inline const com::fbs::app::toast::ToastParams *GetSizePrefixedToastParams(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<com::fbs::app::toast::ToastParams>(buf);
}
...
inline bool VerifySizePrefixedToastParamsBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<com::fbs::app::toast::ToastParams>(nullptr);
}
