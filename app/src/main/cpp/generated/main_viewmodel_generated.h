...
inline const Click (&EnumValuesClick())[1] {
  static const Click values[] = {Click_TEST};
  return values;
}

inline const char *const *EnumNamesClick() {
  static const char *const names[2] = {"TEST", nullptr};
  return names;
}
...
inline const Property (&EnumValuesProperty())[4] {
  static const Property values[] = {Property_UI_DATA, Property_SHOW_EMPTY,
                                    Property_SHOW_ERROR, Property_SHOW_TOAST};
  return values;
}

inline const char *const *EnumNamesProperty() {
  static const char *const names[5] = {"UI_DATA", "SHOW_EMPTY", "SHOW_ERROR",
                                       "SHOW_TOAST", nullptr};
  return names;
}

inline const char *EnumNameProperty(Property e) {
  if (flatbuffers::IsOutRange(e, Property_UI_DATA, Property_SHOW_TOAST))
    return "";
  const size_t index = static_cast<size_t>(e);
...
struct UiDataBuilder {
  ...
  explicit UiDataBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
...
inline flatbuffers::Offset<UiData> CreateUiDataDirect(
  ...
  return com::fbs::app::main::viewmodel::CreateUiData(_fbb, content__);
}
...
struct ShowEmptyBuilder {
  ...
  explicit ShowEmptyBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<ShowEmpty> CreateShowEmptyDirect(
    flatbuffers::FlatBufferBuilder &_fbb, const char *content = nullptr) {
  auto content__ = content ? _fbb.CreateString(content) : 0;
  return com::fbs::app::main::viewmodel::CreateShowEmpty(_fbb, content__);
}
...
struct ShowErrorBuilder {
  ...
  explicit ShowErrorBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<ShowError> CreateShowErrorDirect(
    flatbuffers::FlatBufferBuilder &_fbb, const char *content = nullptr) {
  auto content__ = content ? _fbb.CreateString(content) : 0;
  return com::fbs::app::main::viewmodel::CreateShowError(_fbb, content__);
}

inline const com::fbs::app::main::viewmodel::UiData *GetUiData(
    const void *buf) {
  return flatbuffers::GetRoot<com::fbs::app::main::viewmodel::UiData>(buf);
}

inline const com::fbs::app::main::viewmodel::UiData *GetSizePrefixedUiData(
    const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<
      com::fbs::app::main::viewmodel::UiData>(buf);
}

inline bool VerifyUiDataBuffer(flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<com::fbs::app::main::viewmodel::UiData>(nullptr);
}

inline bool VerifySizePrefixedUiDataBuffer(flatbuffers::Verifier &verifier) {
  return verifier
      .VerifySizePrefixedBuffer<com::fbs::app::main::viewmodel::UiData>(
          nullptr);
}
