...
struct LoadingViewParams FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  int8_t show() const {
    return GetField<int8_t>(VT_SHOW, 0);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_CONTENT) &&
           verifier.VerifyString(content()) &&
           VerifyField<int8_t>(verifier, VT_SHOW, 1) &&
           verifier.EndTable();
  }
};
...
inline flatbuffers::Offset<LoadingViewParams> CreateLoadingViewParamsDirect(
  ...
  return com::fbs::app::loading::CreateLoadingViewParams(
      _fbb,
      content__,
      show);
}

inline const com::fbs::app::loading::LoadingViewParams *GetLoadingViewParams(const void *buf) {
  return flatbuffers::GetRoot<com::fbs::app::loading::LoadingViewParams>(buf);
}

inline const com::fbs::app::loading::LoadingViewParams *GetSizePrefixedLoadingViewParams(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<com::fbs::app::loading::LoadingViewParams>(buf);
}

inline bool VerifyLoadingViewParamsBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<com::fbs::app::loading::LoadingViewParams>(nullptr);
}

inline bool VerifySizePrefixedLoadingViewParamsBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<com::fbs::app::loading::LoadingViewParams>(nullptr);
}
