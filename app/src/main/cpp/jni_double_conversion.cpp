...
Java_com_mgg_environmentcheck_DoubleConversion_nativeDoubleToString(
...
Java_com_mgg_environmentcheck_DoubleConversion_nativeStringToDouble(
  ...
  StringToDoubleConverter converter(flags, 0, Double::NaN(), NULL, NULL,
                                    StringToDoubleConverter::kNoSeparator);
  int processed_characters_count16;
  double result =
      converter.StringToDouble(msg, length, &processed_characters_count16);
